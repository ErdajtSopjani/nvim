...
require('lazy').setup({
  ...
  -- dashboard
  {
    ...
    config = function()
      ...
      -- Function to get the current user, alternatively just replace `os.getenv("USER")` in the greeting
      local function get_user()
        return os.getenv 'USER' or 'Guest'
      end

      -- Function to get the number of plugins loaded
      ...
      local footer = {
        type = 'text',
        val = { '⚡' .. get_num_plugins_loaded() .. ' plugins loaded.' },
      ...
      local bottom_section = {
        type = 'text',
        val = 'Hi ' .. get_user() .. ", It's " .. os.date ' %H:%M ' .. 'How are you doing today?',
